...
<body style="font-family: 'Source Sans Pro', sans-serif;width: 670px;margin: 0 auto;text-align: center;">
    ...
    <h1 style="font-weight: normal;">Just one more step...</h1>
    <hr class="green_bg" style="margin-left: 30px;margin-right: 30px;border: 0.5px solid rgb(82, 205, 147);">
    <p class="p-text" style="font-size: 24px;font-weight: 300;">Hey
        <a href="#" style="color: rgb(82, 205, 147);text-decoration: none;font-weight: 400;">{{$name}}</a>, thanks for creating a Tutella account!</p>
    <p class="p-text" style="font-size: 24px;font-weight: 300;">You're almost ready to start enjoying Tutella. Simply click on the big green button bellow to verify your email adddres
        and you are ready to go!</p>
    <a href="{{$link}}" class="btn_green" style="width: 180px;background: rgb(82, 205, 147);border-radius: 23px;font-size: 14px;font-weight: 300;color: white;border-width: 0;padding: 13px 60px; text-decoration: none;">Verify</a>
    <hr class="grey_bg" style="margin: 40px 30px 0 30px;border: 0.5px solid rgb(235, 235, 235);">
    <div class="footer" style="text-align: left;">
        <p class="small_text" style="font-size: 10px;font-weight: 300;color: rgb(117, 117, 117);margin-left: 30px;margin-bottom: 0;line-height: 0px;">If you’re having trouble with the button above, copy and paste the URL below into your web browser:</p>
        <a href="{{$link}}" style="font-size: 10px;font-weight: 300;color: rgb(210, 210, 210);margin-left: 30px;">{{$link}}</a>
