...
<body style="font-family: 'Source Sans Pro', sans-serif;width: 670px;margin: 0 auto;text-align: center;">
    ...
    <h1 style="font-weight: normal;">Hello {{$name}}</h1>
    <hr class="green_bg" style="margin-left: 30px;margin-right: 30px;border: 0.5px solid rgb(82, 205, 147);">
    <p class="p-text" style="font-size: 24px;font-weight: 300;">It looks like you requested a new password.</p>
    <p class="p-text" style="font-size: 24px;font-weight: 300;">If that sounds right, you can enter new password by clicking the button bellow..</p>
